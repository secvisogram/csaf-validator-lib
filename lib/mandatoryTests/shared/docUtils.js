 ...
 */
exports.hasTrackingRevisionHistory = (doc) =>
 ...
 */
exports.hasTrackingVersionField = (doc) =>
 ...
 */
exports.hasTrackingStatusField = (doc) =>
 ...
 */
exports.collectProductIds = ({ document }) => {
  const entries =
 ...
 * @returns {{id: string, name: string, instancePath: string}[]}
 */
exports.collectGroupIds = ({ document }) => {
  const entries =
    /** @type {{id: string, name: string, instancePath: string}[]} */ ([])
 ...
 */
exports.findMissingDefinitions = (entries, refs) => {
  return refs.filter(
