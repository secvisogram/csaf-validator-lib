export default {
  ...
  weaknesses: [
    ...
    { id: 'CWE-328', name: 'Use of Weak Hash', status: 'Draft', usage: null },
    {
      id: 'CWE-329',
    ...
    { id: 'CWE-416', name: 'Use After Free', status: 'Stable', usage: null },
    {
      id: 'CWE-419',
    ...
    { id: 'CWE-489', name: 'Active Debug Code', status: 'Draft', usage: null },
    {
      id: 'CWE-49',
