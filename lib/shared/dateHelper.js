...
/**
 * Convert a local date in string representation, i.e a date accurate to the day like 'yyyy-mm-dd' to a time zoned day.
 *
 * @param {string} localDateString
 * @returns the UTC-zoned representation of the given local date
 *
 */
