    ...
    },
    {
      ...
      values: [
        ...
        },
        {
          ...
          name: 'Very Unlikely',
          definition:
            '0.05 <= Probability < 0.20. Very unlikely, highly improbable.',
        },
        {
          key: 'U',
          name: 'Unlikely',
        ...
        },
        {
          ...
          definition:
            '0.45 <= Probability < 0.55. Roughly even chance, roughly even odds.',
        },
        {
          key: 'L',
          name: 'Likely',
        ...
        },
        {
          ...
          name: 'Very Likely',
          definition:
            '0.80 <= Probability < 0.95. Very likely, highly probable.',
        },
        {
          key: 'AC',
          name: 'Almost Certain',
      ...
      values: [
        {
          ...
          name: 'Below Median',
          definition:
            'Quantile < 0.50. The lower half of the range of possible values.',
        },
        {
          key: 'A',
          name: 'Above Median',
          definition:
            '0.50 <= Quantile <= 1.0. The upper half of the range of possible values.',
        },
      ],
    },
    {
      ...
      values: [
        {
          ...
          name: 'First Quartile',
          definition:
            'Quantile < 0.25. The lowest 25% of the range of possible values.',
        },
        {
          key: 'Q2',
          name: 'Second Quartile',
          definition:
            '0.25 <= Quantile < 0.50. The second lowest 25% of the range of possible values.',
        },
        {
          key: 'Q3',
          name: 'Third Quartile',
          definition:
            '0.50 <= Quantile < 0.75. The second highest 25% of the range of possible values.',
        },
        {
          key: 'Q4',
          name: 'Fourth Quartile',
          definition:
            '0.75 <= Quantile <= 1.0. The highest 25% of the range of possible values.',
        },
      ],
    },
    {
      ...
      values: [
        {
          ...
          name: 'First Quintile',
          definition:
            'Quantile < 0.20. The lowest 20% of the range of possible values.',
        },
        {
          key: 'Q2',
          name: 'Second Quintile',
          definition:
            '0.20 <= Quantile < 0.40. The second lowest 20% of the range of possible values.',
        },
        {
          key: 'Q3',
          name: 'Third Quintile',
          definition:
            '0.40 <= Quantile < 0.60. The middle 20% of the range of possible values.',
        },
        {
          key: 'Q4',
          name: 'Fourth Quintile',
          definition:
            '0.60 <= Quantile < 0.80. The second highest 20% of the range of possible values.',
        },
        {
          key: 'Q5',
          name: 'Fifth Quintile',
          definition:
            '0.80 <= Quantile <= 1.0. The highest 20% of the range of possible values.',
        },
      ],
    },
    {
      ...
      values: [
        {
          ...
          definition:
            'The vulnerability should be remediated the next time the vulnerable asset receives a scheduled major upgrade or rebuild.',
        },
        {
          key: '60D',
          name: '60 days',
        ...
        },
        {
          ...
          definition:
            'Remediate within 3 days and carry out a forensic triage of the asset to assess whether the system is compromised.',
        },
      ],
    },
    {
      ...
      values: [
        {
          ...
          name: 'Minimal',
          definition:
            'Neither Support nor Essential apply. The vulnerable component may be used within the entities, but it is not used as a mission-essential component, nor does it provide impactful support to mission-essential functions.',
        },
        {
          key: 'S',
          name: 'Support',
        ...
        },
        {
          ...
          name: 'Essential',
          definition:
            'The vulnerable component directly provides capabilities that constitute at least one MEF for at least one entity; component failure may (but does not necessarily) lead to overall mission failure.',
        },
      ],
    },
    {
      ...
      values: [
        {
          ...
          name: 'No',
          definition:
            'The asset is not accessible to unauthenticated or untrusted entities via public networks, such as the internet, regardless of its physical or logical location.',
        },
        {
          key: 'Y',
          name: 'Yes',
          definition:
            'The asset is accessible to unauthenticated or untrusted entities via public networks, such as the internet, regardless of its physical or logical location.',
        },
      ],
    },
    {
      ...
      values: [
        {
          ...
          name: 'Low',
          definition:
            'Safety Impact:(Negligible) AND Mission Impact:(Degraded OR Crippled)',
        },
        {
          key: 'M',
          name: 'Medium',
          definition:
            '(Safety Impact:Negligible AND Mission Impact:MEF Failure) OR (Safety Impact:Marginal AND Mission Impact:(Degraded OR Crippled))',
        },
        {
          key: 'H',
          name: 'High',
          definition:
            '(Safety Impact:Critical AND Mission Impact:(Degraded OR Crippled)) OR (Safety Impact:Marginal AND Mission Impact:MEF Failure)',
        },
        {
          key: 'VH',
          name: 'Very High',
    ...
    },
    {
      ...
      values: [
        ...
        },
        {
          ...
          name: 'Marginal',
          definition:
            'Any one or more of these conditions hold. **Physical harm**: Major injuries to one or more persons (IEC 61508 Marginal). **Operator resiliency**: Requires action by system operator to maintain safe system state as a result of exploitation of the vulnerability where operator actions would be within their capabilities but the actions require their full attention and effort; OR significant distraction or discomfort to operators; OR causes significant occupational safety hazard. **System resiliency**: System safety margin effectively eliminated but no actual harm; OR failure of system functional capabilities that support safe operation. **Environment**: Major externalities (property damage, environmental damage, etc.) imposed on other parties. **Financial**: Financial losses that likely lead to bankruptcy of multiple persons. **Psychological**: Widespread emotional or psychological harm, sufficient to be cause for counselling or therapy, to populations of people.',
        },
        {
          key: 'R',
          name: 'Critical',
          definition:
            'Any one or more of these conditions hold. **Physical harm**: Loss of life (IEC 61508 Critical). **Operator resiliency**: Actions that would keep the system in a safe state are beyond system operator capabilities, resulting in adverse conditions; OR great physical distress to system operators such that they cannot be expected to operate the system properly. **System resiliency**: Parts of the cyber-physical system break; system’s ability to recover lost functionality remains intact. **Environment**: Serious externalities (threat to life as well as property, widespread environmental damage, measurable public health risks, etc.) imposed on other parties. **Financial**: Socio-technical system (elections, financial grid, etc.) of which the affected component is a part is actively destabilized and enters unsafe state. **Psychological**: N/A.',
        },
        {
          key: 'C',
          name: 'Catastrophic',
          definition:
            'Any one or more of these conditions hold. **Physical harm**: Multiple loss of life (IEC 61508 Catastrophic). **Operator resiliency**: Operator incapacitated (includes fatality or otherwise incapacitated). **System resiliency**: Total loss of whole cyber-physical system, of which the software is a part. **Environment**: Extreme externalities (immediate public health threat, environmental damage leading to small ecosystem collapse, etc.) imposed on other parties. **Financial**: Social systems (elections, financial grid, etc.) supported by the software collapse. **Psychological**: N/A.',
        },
      ],
    },
    {
