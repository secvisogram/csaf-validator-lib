...
// A CSAF Extension Schema registered/known to this implementation. It is used
// by the OASIS CSAF conformance test suite to exercise mandatory test 6.1.60.2
// ("Extension Schema").
export default {
