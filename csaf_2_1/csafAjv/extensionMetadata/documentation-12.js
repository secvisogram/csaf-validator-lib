// https://raw.githubusercontent.com/oasis-tcs/csaf/refs/heads/master/csaf_2.1/extension/data/valid/documentation-12/documentation-12-metadata_1.0.0.json
// CSAF Extension Metadata for the "documentation-12" CSAF Extension used by
...
export default {
  ...
  requirement: {
    '$.document.x_extensions': { max_occurrence: 4096 },
    '$.product_tree.branches..product.x_extensions': { max_occurrence: 4096 },
    ...
    '$.vulnerabilities[*].x_extensions': { max_occurrence: 4096 },
    '$.x_extensions': { max_occurrence: 4096 },
  },
}
