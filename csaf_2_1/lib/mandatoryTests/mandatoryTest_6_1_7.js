      ...
      (vulnerability) =>
        (Array.isArray(vulnerability.metrics) &&
          vulnerability.metrics.every(
            (
              /** @type {{ products?: unknown; cvss_v2?: any; cvss_v3?: any; cvss_v4?: any  }} */ metric
            ) =>
              Array.isArray(metric.products) &&
                metric.products.every((product) => typeof product === 'string') &&
              ((metric.cvss_v2 &&
                (typeof metric.cvss_v2.version === 'string' ||
                    metric.cvss_v2.version === undefined)) ||
                  metric.cvss_v2 === undefined) &&
              ((metric.cvss_v3 &&
                (typeof metric.cvss_v3.version === 'string' ||
                    metric.cvss_v3.version === undefined)) ||
                  metric.cvss_v3 === undefined)&&
                ((metric.cvss_v4 &&
                        (typeof metric.cvss_v4.version === 'string' ||
                            metric.cvss_v4.version === undefined)) ||
                    metric.cvss_v4 === undefined)
          )) ||
